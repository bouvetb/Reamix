...
namespace VRTK
{
    ...
    public class VRTK_InteractableObject : MonoBehaviour
    {
        ...
        {
            /*ZeroVelocity();
            Vector3 positionInit = new Vector3(-8.24f,2.12f,-5.63f);
            
            //GetComponent<Rigidbody>().AddForce(positionInit * 10f * Time.deltaTime);
            //transform.position = positionInit;
            
            transform.position = Vector3.MoveTowards(transform.position, positionInit, 10f * Time.deltaTime);*/
